(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CardNewComponent = /** @class */ (function () {
                function CardNewComponent(_data) {
                    var _this = this;
                    this._data = _data;
                    this.datosApi = "";
                    this._data.getNoticias()
                        ...
                        _this.datosApi = data;
                        console.log(_this.datosApi);
                    });
                }
                return CardNewComponent;
            }());
            CardNewComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeprincipalComponent = /** @class */ (function () {
                function HomeprincipalComponent(_data, Router) {
                    var _this = this;
                    this._data = _data;
                    this.Router = Router;
                    this.datosApi = "";
                ...
                HomeprincipalComponent.prototype.verNoticia = function (i) {
                    console.log(i);
                };
                return HomeprincipalComponent;
            }());
            HomeprincipalComponent.ctorParameters = function () { return [
                { type: src_app_services_service_service__WEBPACK_IMPORTED_MODULE_2__["ServiceService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TopnewsComponent = /** @class */ (function () {
                function TopnewsComponent(_data) {
                    var _this = this;
                    this._data = _data;
                    this.apiTopNews = "";
                    this._data.getTopNews()
                        .subscribe(function (data) {
                        _this.apiTopNews = data;
                    });
                }
                TopnewsComponent.prototype.buscarNoticia = function (noticia) {
                    console.log(noticia);
                    console.log(this.apiTopNews);
                };
                return TopnewsComponent;
            }());
            TopnewsComponent.ctorParameters = function () { return [
                { type: src_app_services_service_service__WEBPACK_IMPORTED_MODULE_2__["ServiceService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ServiceService = /** @class */ (function () {
                function ServiceService(_data) {
                    this._data = _data;
                }
                ServiceService.prototype.getNoticias = function () {
                ...
                ServiceService.prototype.getTopNews = function () {
